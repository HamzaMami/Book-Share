  ...
  Future<void> _handleSignUp() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        await _databaseService.saveUserData(user.uid, firstName, lastName, email);
      }

      if (!mounted) return;

      // Auto-login: go straight to home, no need to sign in again
                  ...
                  children: [
                    Expanded(
                      child: DefaultFormField(
                        ...
                        onChange: (value) => setState(() => firstNameValue = value),
                      ),
                    ),
                    ...
                    Expanded(
                      child: DefaultFormField(
                        ...
                        onChange: (value) => setState(() => lastNameValue = value),
                      ),
                    ),
                  ],
                ),
